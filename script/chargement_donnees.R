...
p_surface[is.na(d3ejb$area_migration_frame)&d3ejb$pdebit4>0,7]<-1 # passage par la vanne fenêtres de visu =0 
#################""
# simplification
###############
...
# voir essai_prior_efficacite.R pour paramètrage inital
######################################"
...
######################################################
# je cherche les effectifs qui apparaissent comme des parenth�ses dans d3ejb
...
indexOK<-d3ej$dsf_fls_id==0&d3ej$ex==1 # effectifs utilis�s pour extrapolation plus loin
indexOK[is.na(indexOK)]<-FALSE
d3ej$indexOK<-indexOK
d3ej$Nprimo4[!indexOK]<-NA
# Essai Je repasse à des sommes en ligne et colonnes pour ajustement du modèle
...
# proportions th�oriques par heure
